...
def prepare(
    destination_path: Path = Path("data/phi"),
    checkpoint_dir: Path = Path("checkpoints/microsoft/Phi-3.5-mini-instruct"),
    val_split_fraction: float = 0.03865,  # to get exactly 2000 validation samples,
    seed: int = 42,
    mask_inputs: bool = False,  # as in alpaca-lora
    data_file_name: str = "phi_data_cleaned.json",
    data_file_url: str = "https://raw.githubusercontent.com/*/phi_data_cleaned.json",
